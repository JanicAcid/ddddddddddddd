...
const faqPage = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Стоимость настройки маркировки зависит от состояния кассы. Базовая настройка для действующей кассы начинается от 3 000 рублей — подключение ЭДО, Честный ЗНАК, ТС ПИоТ и привязка кассы. Для новой кассы — от 5 000 рублей. Для б/у касс — от 4 000 рублей. Полный пакет «под ключ» с обучением — от 7 000 рублей.',
      },
    },
    {
      '@type': 'Question',
