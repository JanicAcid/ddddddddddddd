...
export const metadata: Metadata = {
  ...
  description:
    'Настройка кассы для маркировки товаров в Санкт-Петербурге. Меркурий, Атол, Эвотор, Штрих-М. Цена от 3 000 ₽. Под ключ за 1 день, без ошибок. ФФД 1.2, Честный ЗНАК, ЭДО, ТС ПИоТ. Бесплатная консультация.',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'Настройка кассы под ключ для маркировки товаров в Санкт-Петербурге. Меркурий, Атол, Эвотор, Штрих-М. Цена от 3 000 ₽. За 1 день, без ошибок.',
    url: PAGE_URL,
...
const jsonLdService = {
  ...
  offers: {
    ...
    price: '3000',
    priceCurrency: 'RUB',
    description: 'Базовая настройка кассы для маркировки от 3 000 ₽',
  },
}
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Базовая настройка кассы для маркировки начинается от 3 000 ₽. Полная настройка под ключ с подключением всех систем (ЭДО, Честный ЗНАК, ТС ПИоТ, ФНС, ОФД) стоит от 8 000 до 15 000 ₽. Для б/у касс добавляется +2 000 ₽ на обновление прошивки. Точную стоимость можно рассчитать в нашем бесплатном калькуляторе за 2 минуты.',
      },
    },
    {
      '@type': 'Question',
...
const FAQS = [
  {
    ...
    a: 'Базовая настройка кассы для маркировки начинается от 3 000 ₽. Полная настройка под ключ с подключением всех систем (ЭДО, Честный ЗНАК, ТС ПИоТ, ФНС, ОФД) стоит от 8 000 до 15 000 ₽ в зависимости от бренда кассы и набора услуг. Для б/у касс добавляется +2 000 ₽ на обновление прошивки. Рассчитайте точную стоимость в нашем бесплатном <Link href="/" className="text-[#1e3a5f] underline underline-offset-2 hover:text-[#2a5080]">калькуляторе</Link> — это занимает 2 минуты.',
  },
  {
