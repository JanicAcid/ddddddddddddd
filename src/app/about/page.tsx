...
export const metadata: Metadata = {
  title: 'О компании — ООО «Теллур-Интех» | Сервисный центр касс с 1995 года',
  description: 'ООО «Теллур-Интех» — сервисный центр кассового оборудования в Санкт-Петербурге с 1995 года. Более 30 лет опыта. Офисы: СПб (ул. Заслонова 32-34), Пушкин, Гатчина. Подключение маркировки, ремонт касс, ЭДО.',
  ...
  openGraph: {
    ...
    description: 'Сервисный центр кассового оборудования в Санкт-Петербурге с 1995 года.',
    url: `${SITE_URL}/about`,
