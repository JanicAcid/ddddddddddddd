    ...
    <section className="mb-4 sm:mb-6 space-y-4" aria-label="Информация о компании и услугах маркировки">
      ...
      <div className="bg-white rounded-xl border border-[#1e3a5f]/10 p-4 sm:p-5">
        ...
        <p className="text-sm text-slate-600 leading-relaxed">
          Работаем по&nbsp;всей <strong>Ленинградской области</strong>: Санкт-Петербург, Пушкин, Гатчина, Павловск, Колпино, Красное Село, Ломоносов, Петергоф, Всеволожск, Выборг, Тосно, Кировск, Сертолово, Кудрово, Шушары, Парголово, Мурино и&nbsp;другие города. Возможен выезд инженера на&nbsp;территорию клиента в&nbsp;день обращения. Для некоторых услуг доступна <strong>удалённая настройка маркировки</strong> без выезда.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {[
            ...
            },
            {
              ...
              desc: 'Полная настройка маркировки под ключ — от 1 до 3 рабочих дней. Регистрация ККТ в ФНС, ЭДО, Честный ЗНАК, ТС ПИоТ за один визит инженера.',
            },
            {
      ...
      {/* ===== Городские анкоры — расширенный ===== */}
      <div className="bg-white rounded-xl border border-[#1e3a5f]/10 p-4 sm:p-5">
        <h2 className="text-base sm:text-lg font-bold text-[#1e3a5f] mb-3">
          Подключение маркировки в&nbsp;городах Ленинградской области
        </h2>
        <p className="text-sm text-slate-600 leading-relaxed mb-2">
          Наши инженеры выезжают в&nbsp;любой город Ленинградской области. Кратчайшие сроки выезда для жителей Пушкина, Гатчины и&nbsp;Южного района Санкт-Петербурга&nbsp;— офисы расположены рядом. Для остальных направлений выезд согласовывается индивидуально.
        </p>
        <p className="text-sm text-slate-600 leading-relaxed">
          Обслуживаем: <strong>Санкт-Петербург</strong> (все районы), Пушкин, Гатчина, Павловск, Колпино, Красное Село, Ломоносов, Петергоф, Всеволожск, Выборг, Тосно, Кировск, Сертолово, Кудрово, Шушары, Мурино, Парголово, Всеволожский район, Всеволожск, Зеленогорск, Сестрорецк, Кронштадт, Петергоф, Волосово, Волосовский район, Гатчинский район, Тосненский район, Выборгский район, Всеволожский район, Приозерск, Сланцы, Луга, Подпорожье, Бокситогорск и&nbsp;другие населённые пункты Ленинградской области. Возможна удалённая настройка маркировки без выезда инженера.
        </p>
      </div>
