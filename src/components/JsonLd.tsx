...
const organization = {
  ...
  description: 'Сервисный центр кассового оборудования в Санкт-Петербурге и Ленинградской области с 1995 года. Подключение маркировки, обслуживание ККТ, регистрация в ФНС, настройка Честного ЗНАК, ЭДО, ТС ПИоТ.',
  foundingDate: '1995',
  address: {
    '@type': 'PostalAddress',
...
const localBusiness = {
  ...
  description: 'Подключение маркировки товаров под ключ в Санкт-Петербурге и Ленинградской области. Регистрация ККТ в ФНС, настройка Честного ЗНАК, ЭДО, ТС ПИоТ, ОФД. Обслуживание касс Меркурий, Атол, Сигма, Эвотор, Штрих-М, Пионер, AQSI.',
  url: SITE_URL,
  image: `${SITE_URL}/logo.webp`,
  logo: `${SITE_URL}/logo.webp`,
  priceRange: '$$',
...
const webApplication = {
  ...
  description: 'Бесплатный онлайн-калькулятор стоимости подключения маркировки для кассового оборудования Меркурий, Атол, Сигма, Эвотор, Штрих-М, Пионер, AQSI. Расчёт за 2 минуты. Санкт-Петербург и Ленинградская область.',
  url: SITE_URL,
...
const faqPage = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Мы работаем в Санкт-Петербурге и Ленинградской области. Офисы в Пушкине, Гатчине и центре Санкт-Петербурга. Также выезжаем в Павловск, Колпино, Красное Село, Ломоносов, Петергоф, Всеволожск, Выборг, Тосно, Кировск и другие города Ленинградской области. Возможна удалённая настройка для некоторых услуг.',
      },
    },
    {
      '@type': 'Question',
...
const markingService = {
  ...
  description: 'Комплексное подключение маркировки для розничных точек продаж: настройка ЭДО, Честного ЗНАК, ТС ПИоТ, регистрация ККТ в ФНС, подключение ОФД. Обслуживаем кассы Меркурий, Атол, Сигма, Эвотор, Штрих-М, Пионер, AQSI. Работаем в Санкт-Петербурге и Ленинградской области.',
