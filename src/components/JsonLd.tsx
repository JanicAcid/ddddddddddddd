...
const localBusiness = {
  ...
  description: 'Подключение маркировки товаров под ключ в Санкт-Петербурге и Ленинградской области. Три офиса: СПб, Пушкин, Гатчина. Регистрация ККТ в ФНС, настройка Честного ЗНАК, ЭДО, ТС ПИоТ, ОФД. Удалённая настройка. Обслуживание касс Меркурий, Атол, Сигма, Эвотор, Штрих-М, Пионер, AQSI.',
  url: SITE_URL,
  image: `${SITE_URL}/logo.webp`,
  logo: `${SITE_URL}/logo.webp`,
  priceRange: '$$',
