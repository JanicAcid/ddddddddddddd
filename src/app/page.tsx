...
export default function TellurServiceCalculator() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f0f4f8] to-[#e8ecf2] flex flex-col relative">
        {/* Полупрозрачный фон с инженером для лояльности — нижний правый угол */}
        <div className="fixed bottom-0 right-0 w-[70%] sm:w-[55%] md:w-[45%] h-[60vh] -z-10 pointer-events-none overflow-hidden">
          <img src="/engineer-bg.webp" alt="" className="absolute bottom-0 right-0 w-full h-full object-cover object-top opacity-[0.25]" />
        </div>
