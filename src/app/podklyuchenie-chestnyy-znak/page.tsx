...
export const metadata: Metadata = {
  ...
  description:
    'Подключение Честный ЗНАК в Санкт-Петербурге. Регистрация для ИП и ООО, настройка рабочего места, привязка кассы. Цена от 3 000 ₽. За 1 день. Бесплатная консультация.',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'Регистрация и подключение Честного ЗНАК в Санкт-Петербурге для ИП и ООО. Цена от 3 000 ₽. Настройка под ключ за 1 день.',
    url: PAGE_URL,
...
const jsonLdService = {
  ...
  description:
    'Регистрация и подключение к государственной системе маркировки Честный ЗНАК в Санкт-Петербурге для ИП и ООО. Оформление УКЭП, настройка личного кабинета, привязка кассы, обучение. Цена от 3 000 ₽. За 1 день.',
  ...
  offers: {
    ...
    price: '3000',
    priceCurrency: 'RUB',
    description: 'Подключение Честного ЗНАК под ключ от 3 000 ₽',
  },
}
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Регистрация в Честном ЗНАКе бесплатная — это государственная система. Платная часть — настройка и подключение всех компонентов: УКЭП, настройка кабинета, привязка кассы, настройка ТС ПИоТ, обучение. Стоимость настройки под ключ от 3 000 ₽. Полная настройка с кассой — от 8 000 ₽.',
      },
    },
    {
      '@type': 'Question',
...
const FAQS = [
  {
    ...
    a: 'Сама регистрация в Честном ЗНАКе — бесплатная, это государственная система. Платная часть — это работа специалиста по настройке всех компонентов: помощь с УКЭП, регистрация, настройка кабинета, привязка кассы, ТС ПИоТ, обучение сотрудников. Стоимость настройки под ключ начинается от 3 000 ₽. Рассчитайте точную стоимость в нашем бесплатном <Link href="/" className="text-[#1e3a5f] underline underline-offset-2 hover:text-[#2a5080]">калькуляторе</Link>.',
  },
  {
      ...
      <div className="max-w-3xl mx-auto px-3 sm:px-4 py-6 sm:py-8">
        ...
        <div className="text-center mb-8 sm:mb-10">
          ...
          <p className="mt-3 text-sm sm:text-base text-slate-500 max-w-2xl mx-auto">
            ...
            Цена от 3 000 ₽. Бесплатная консультация.
          </p>
        </div>
        ...
        <section className="mb-10 sm:mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-4 text-center">
              ...
              <p className="text-2xl font-extrabold text-[#1e3a5f]">от 3 000 ₽</p>
