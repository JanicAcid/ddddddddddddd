...
const jsonLdFaq = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Какая главная требования к кассе для маркировки?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Касса должна поддерживать формат фискальных документов (ФФД) версии 1.2 и работать с фискальным накопителем ФН 1.1М или новее. Это обязательное требование для передачи данных о маркированных товарах в Честный ЗНАК через ОФД.',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Бюджетные модели (Меркурий 115Ф, Атол 25Ф) — от 8 000 ₽. Средний сегмент (Эвотор 5, Атол Sigma 10) — 15 000–30 000 ₽. Флагманские решения (Эвотор 7.3, Атол 90Ф, Pirit 2Ф) — от 35 000 ₽. К цене кассы добавьте стоимость ФН (8 000–13 000 ₽) и настройку (от 1 500 ₽).',
      },
    },
    {
      '@type': 'Question',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-3 sm:px-4 py-6 sm:py-8">
        ...
        <section className="mb-10 sm:mb-12">
          ...
          <p className="text-sm sm:text-[15px] text-slate-600 leading-relaxed mb-4">
            Если вы уже используете онлайн-кассу и unsure, подходит ли она для маркировки — не
