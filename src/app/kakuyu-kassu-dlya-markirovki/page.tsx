...
const jsonLdFaq = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Бюджетные мобильные кассы (Меркурий 115Ф, Меркурий-119Ф) — от 10 000 ₽. Смарт-терминалы среднего сегмента (Эвотор 5, Атол Sigma 7Ф) — от 24 900 до 32 000 ₽. Флагманские решения (Эвотор 7.3, Атол Sigma 8Ф) — от 42 000 ₽. К цене кассы добавьте стоимость ФН (8 000–13 000 ₽) и настройку (от 1 500 ₽).',
      },
    },
    {
      '@type': 'Question',
...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Бюджетные модели (Меркурий 115Ф, Меркурий-119Ф) — от 10 000 ₽. Смарт-терминалы среднего сегмента (Эвотор 5, Атол Sigma 7) — от 22 000 до 32 000 ₽. Флагманские решения (Эвотор 7.3, Атол Sigma 8, Pirit 2Ф) — от 32 000 до 45 000 ₽. К стоимости кассы добавьте: фискальный накопитель (8 000–13 000 ₽ в зависимости от срока), настройку под маркировку (от 1 500 ₽) и при необходимости внешний 2D-сканер (от 3 000 ₽). Рассчитайте точную стоимость в нашем бесплатном <Link href="/" className="text-[#1e3a5f] underline underline-offset-2 hover:text-[#2a5080]">калькуляторе маркировки</Link>.',
  },
  {
